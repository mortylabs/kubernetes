...
> A lightweight K3s-based Kubernetes cluster, currently running version **`v1.36.4+k3s1`** as of **17th September 2026**, tailored for a personal homelab hosting `Home Assistant`, `InfluxDB`, `Grafana`, `MQTT`, `UniFi Controller`, `Pi-hole`, `deCONZ`, and more.
...
Below will install cert-manager **v1.20.4**, which is the latest version as of **17th September 2026**.
